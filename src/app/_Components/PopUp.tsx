...
import * as psd from "../_Styles/PostUploadDialog.styles";
...
import {
  ...
  FetchSignUp,
  FetchUploadPost,
} from "../_PageComponents/FetchList";
...
import {
  ...
  notFoundError,
  raiseError,
} from "../_PageComponents/StaticComponents";
import {
  DialogTitle,
  DialogActions,
  FormControlLabel,
...
import { GoogleButton } from "../_LoginComponents/Google";
import NaverLogin from "../_LoginComponents/Naver";
import { VerifyEmailComponents } from "./Email";
...
import { DoubleSlideInput } from "./DoubleSlideInput";
import { SingleSlideInput } from "./SingleSlideInput";
import { SingleValueViewer, ValueRangeViewer } from "./ValueViewer";

import { LocationInput } from "../_InputComponents/LocationInput";
import { DoubleDatePicker } from "../_InputComponents/DoubleDatePicker";
import { priceToString } from "../_PageComponents/StaticComponents";
import { ImageUploadComponent } from "../_InputComponents/ImageInput";
import { useUserInfoStore } from "../_Store/UserInfoStore";
import { guestInfoPopUpStore } from "../_Store/GuestInfoStore";
import { CustomWindow, RequestRoom, Room } from "../RoomType";
...
export function LoginDialog() {
  ...
  const idList = {
    google: process.env.REACT_APP_GOOGLE_CLIENT_ID as string,
  };
...
export const PostEditDialog = (post: { post: Room }) => {
  const image: File[] = [];
